        ...
        public IList<string> checkParametersList(IList<Object> parameters)
        {
            ...
            for (int i = 0; i < parameters.Count && i < 3; i++)
            {
                ...
                if (i == 2)
                {
                    ...
                    if (_a <= _b)
                        errorsList.Add("Параметр \"частота 1й синусоиды\" должен быть больше чем \"частота 2й синусоиды\"");
                    if (_b <= _c)
                        errorsList.Add("Параметр \"частота 2й синусоиды\" должен быть больше чем \"частота 3й синусоиды\"");
                }
            }
